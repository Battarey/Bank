...
def upgrade() -> None:
	...
	op.alter_column(
		"personal_data", "gender", existing_type=sa.CHAR(length=1), type_=sa.String(length=1), existing_nullable=False
	)
...
def downgrade() -> None:
	# ### commands auto generated by Alembic - please adjust! ###
	op.alter_column(
		"personal_data", "gender", existing_type=sa.String(length=1), type_=sa.CHAR(length=1), existing_nullable=False
	)
	op.alter_column(
		"personal_data",
		"middle_name",
	...
	op.create_unique_constraint(
		op.f("uq_passport_series_number"), "passport", ["series", "number"], postgresql_nulls_not_distinct=False
	)
	op.alter_column(
		"passport",
		"division_code",
