...
app.include_router(transactions_router, dependencies=[Depends(verify_internal_key)])
app.include_router(history_router, dependencies=[Depends(verify_internal_key)])
