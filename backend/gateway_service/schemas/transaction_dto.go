...
type TransferRequest struct {
	...
	// Сумма перевода
	Amount string `json:"amount" example:"500.00" validate:"required"`
...
type CreateTransactionRequest struct {
	...
	// Сумма операции
	Amount string `json:"amount" example:"1000.00" validate:"required"`
...
type ExchangeRequest struct {
	...
	Amount string `json:"amount" example:"100.00" validate:"required"`
}
...
type ExchangeRatesResponse struct {
	...
	Rates map[string]string `json:"rates" example:"USD:0.0108,EUR:0.0102"`
}
...
type ExchangeRatePairResponse struct {
	...
	Rate string `json:"rate" example:"0.0108"`
	// Время обновления
	LastUpdated string `json:"last_updated" example:"2023-10-27T10:00:00Z"`
}
