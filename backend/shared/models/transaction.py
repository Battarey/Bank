...
class Transaction(Base):
	...
	idempotency_key: Mapped[UUID | None] = mapped_column(PGUUID(as_uuid=True), unique=True, index=True, nullable=True)

	__table_args__ = (Index("ix_transactions_acc_created", "account_id", text("created_at DESC")),)
