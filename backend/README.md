...
> Все сервисы запускаются с `restart: unless-stopped` и используют механизмы `depends_on` для соблюдения порядка старта.
...
---
Подробное описание инфраструктуры и способов запуска находится в **[README инфраструктуры](../infra/README.md)**.
