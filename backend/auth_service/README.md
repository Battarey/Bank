...
Для обеспечения безопасности аккаунтов сервис применяет строгие правила блокировок и rate-limiting.

Подробное описание:
- **[Политика блокировки PIN-кода](../../infra/docs/api_standards.md#политика-блокировки-pin-кода)**
- **[Схема хранения сессий в Redis](../../infra/README.md#инфраструктурные-сервисы)**
