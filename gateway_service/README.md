...
|------------------|-----------------------------------------------|----------------------|
| Точное совпадение | `/health`, `/docs`, `/auth/login-pin`        | Системные + вход     |
...
```
Клиент                          Gateway                    customer_service       Redis
  │                                │                              │                  │
  │  POST /users/start             │                              │                  │
  │──────────────────────────────▶│  forward_request()           │                  │
  │                                │─────────────────────────────▶│                  │
...
| 409  | Конфликт данных (например, дубликат ИНН/СНИЛС)                |
